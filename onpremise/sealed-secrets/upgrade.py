...
# ============================================================
CONFIG = {
    "SCRIPT_NAME":    "Sealed Secrets Helm Chart Upgrade Script",
    "HELM_REPO_NAME": "sealed-secrets",
    "HELM_REPO_URL":  "https://bitnami.github.io/sealed-secrets",
    "HELM_CHART":     "sealed-secrets/sealed-secrets",
    "CHANGELOG_URL":  "https://github.com/bitnami/sealed-secrets/releases",
